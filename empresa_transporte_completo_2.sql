-- =========================================================
-- Empresa de Transporte - script completo
-- Fuerza UTF-8 en la conexión aunque phpMyAdmin/consola tenga
-- otro charset seleccionado, para evitar errores con tildes/ñ.
-- =========================================================
SET NAMES utf8mb4;
...
-- =========================================================
-- PREGUNTA 2: CREACIÓN DE VISTAS (Consultas solicitadas)
-- =========================================================
...
-- =========================================================
-- PREGUNTA 3: 2 CONSULTAS PROPIAS (mínimo una con 3 tablas)
-- =========================================================

-- Consulta 1
-- Pregunta: ¿Qué camión conduce cada camionero y cuántos paquetes ha
-- despachado ese camión? (usa 3 tablas: CAMIONERO, CAMION, PAQUETE)
SELECT
...
-- Consulta 2
-- Pregunta: ¿Cuántos paquetes se han despachado hacia cada ciudad,
-- indicando también a qué provincia pertenece esa ciudad?
-- (usa 3 tablas: PROVINCIA, CIUDAD, PAQUETE)
SELECT
